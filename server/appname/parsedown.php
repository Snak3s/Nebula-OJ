...
class Parsedown
{
	...
	$markup = str_replace("<table", "<table class=\"ui celled center aligned table\"", $markup);

	# add classes for blockquote
	$markup = str_replace("<blockquote", "<blockquote class=\"ui blue message\"", $markup);
    ...
    protected function blockFencedCodeContinue($Line, $Block)
    {
        ...
        if (
            ...
            and strlen($matches[1]) >= $Block['openerLength']
        ) {
